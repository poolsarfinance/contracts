...
contract StarToken is ERC20('Poolsar', 'STAR') {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of Stares
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. Stares to distribute per block.
        uint256 lastRewardBlock;  // Last block number that Stares distribution occurs.
        uint256 accStarPerShare;   // Accumulated Stares per share, times 1e18. See below.
    ...
    uint256 public StarPerBlock = 0.015 ether;
    ...
    // View function to see pending Stares on frontend.
    ...
    // Safe Star transfer function, just in case if rounding error causes pool to not have enough FOXs.
